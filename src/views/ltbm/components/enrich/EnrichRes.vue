		...
		<div class="EnrichTabs">
			<a-tabs v-model:activeKey="switchOption.activeTabKey" size="large">
				<a-tab-pane key="table">
					...
					<EnrichTable :regulation="regulation"></EnrichTable>
				</a-tab-pane>
				...
				<a-tab-pane key="words">
					...
					<EnrichWordCloudPlot :regulation="regulation"></EnrichWordCloudPlot>
				</a-tab-pane>
			</a-tabs>
		</div>
		<div><EnrichInfo :regulation="regulation"></EnrichInfo></div>
	</div>
</template>
...
import EnrichTable from '@/views/ltbm/components/enrich/EnrichTable.vue'
import EnrichTopBubblePlot from '@/views/ltbm/components/enrich/EnrichTopBubblePlot.vue'
import EnrichWordCloudPlot from '@/views/ltbm/components/enrich/EnrichWordCloudPlot.vue'
import EnrichInfo from '@/views/ltbm/components/enrich/EnrichInfo.vue'

...
watch(
	() => degParamStore.oraItemInfo[props.regulation],
	() => {
...
async function updateVennPlotData(plot: any) {
	const data = [
		{
			sets: ['Query Size'],
			size: degParamStore.oraItemInfo[props.regulation].query_size,
			label: 'Query Size',
		},
		{
			sets: ['Term Size'],
			size: degParamStore.oraItemInfo[props.regulation].term_size,
			label: 'Term Size',
		},
		{
			sets: ['Query Size', 'Term Size'],
			size: degParamStore.oraItemInfo[props.regulation].intersection_size,

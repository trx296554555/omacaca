export default {
	...
	ltbm_introduction: {
		...
		stage_a:
			'First sampling, 21 baby monkeys lived with their mothers in adult housing; \
		...
		stage_m:
			'At the same time of first sampling, samples of each baby monkey mother were also collected; \
			these female monkeys lived in the adult housing and ate adult feed and seasonal fresh fruits.',
		stage_b:
			'Second sampling, 21 baby monkeys lived in a large cage (monkey kindergarten). Diet formula was baby monkey feed + fruit + milk powder.',
		stage_c:
			'Third sampling, 21 baby monkeys lived in a large cage (monkey kindergarten). Diet formula was baby monkey feed + fruit + milk powder.',
		stage_c_note:
			'After sampling, stop feeding milk powder and transfer to a small cage (2 per a cage) in the veterinary room',
		stage_d:
			'Fourth sampling, every two baby monkeys lived in a small cage. Diet formula was baby monkey feed + fruit + special additives.',
		stage_d_note:
		...
		stage_e:
			'Fifth sampling, every two baby monkeys lived in a small cage. Diet formula was baby monkey feed + fruit',
		stage_f:
			'Sixth sampling, the 21 baby monkeys were back in the large cage (monkey kindergarten),\
		...
		stage_g:
			'Seventh sampling, 21 baby monkeys lived in the large cage (monkey kindergarten). Diet formula was new baby monkey feed + fruit',
		stage_g_note:
			'The two monkeys, BCR03 and BCR20, had developed diarrhea and under treatment were dead before this sampling',
		stage_o:
			'Considering that lactating female monkeys may be in a special physiological state, \

export default {
	...
	ltbm_dega: {
		...
		setp2option1infoa:
			'校正【性别】因素的影响，以【阶段】作为影响比较结果的主要因素，支持小猴阶段A-G之间两两比较。',
		setp2option1infon:
			'无校正，以【阶段】作为影响比较结果的主要因素，支持小猴阶段A-G之间两两比较。',
		setp2option2infot:
			'校正【阶段】因素的影响，以【性别】作为影响比较结果的主要因素，仅支持所有阶段性别比较。',
		setp2option2infof: '无校正，以【性别】作为影响比较结果的主要因素，支持各个阶段内性别比较。',
		setp2option3infoa:
			'校正【性别】因素的影响，以【环境】作为影响比较结果的主要因素，支持环境1-4之间两两比较。',
		setp2option3infon:
			'无校正，以【环境】作为影响比较结果的主要因素，支持环境1-4之间两两比较。',
		setp2option4infoa:
			'校正【性别】因素的影响，以【阶段】作为影响比较结果的主要因素，支持小猴阶段A-G与母猴（M）与正常成年猕猴（O）两两比较。',
		setp2option4infon:
			'无校正，以【阶段】作为影响比较结果的主要因素，支持小猴阶段A-G与母猴（M）与正常成年猕猴（O）两两比较。',
		setp2option5info: '任选数据构成矩阵，根据所选数据自定义设计公式输入。(功能开发中)',
		step3: '3、是否使用完整数据矩阵',
		step3info:
